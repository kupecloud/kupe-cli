...
func TestValidateKupeURL(t *testing.T) {
	cases := []struct {
		...
		{"http scheme on kupe.cloud rejected", "http://api.kupe.cloud", true},
		{"with port", "https://api.kupe.cloud:8443", false},
		{"localhost rejected (not kupe host)", "http://localhost:8080", true},
		{"127.0.0.1 rejected (not kupe host)", "http://127.0.0.1:8080", true},
